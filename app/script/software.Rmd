...
### Github Repositories
 ...
 - [pythonR](https://barrettk.github.io/pythonR/): A developer R package for using python
 - [songClip](https://github.com/MLVisions/songClip): Prototype R package for running a DJ booth. Runs an R shiny app.
