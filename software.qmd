...
- I have contributed to many of the packages found at <a href="https://github.com/metrumresearchgroup" target="_blank">github.com/metrumresearchgroup</a>, relating to NONMEM model management & submission, data visualization, data summarization & formatting (latex, HTML, RTF, and MS word), software validation, and R shiny. See our poster [here](http://dx.doi.org/10.13140/RG.2.2.33760.05129).
...
- I helped develop other apps on <a href="https://www.covidpharmacology.com/in-silico-workbench/"  target="_blank">Certara's website</a> using the `flexdashboard` R package, though I wouldn't count this as R shiny experience given the R package's simplicity and lack of available UI customization.
